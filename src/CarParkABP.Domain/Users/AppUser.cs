...
namespace CarParkABP.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update CarParkABPDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update CarParkABPEfCoreEntityExtensionMappings to extend the IdentityUser entity
